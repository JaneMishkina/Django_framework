...
#
# Использование представлений осуществляется путем указания их имени в URL-адресе приложения.
# Например, для функционального представления hello() и классового представления HelloView:
...
# Здесь мы определяем URL-шаблоны для функционального представления hello() и классового представления HelloView и др.
urlpatterns = [
